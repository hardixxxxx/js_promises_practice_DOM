...
const thirdPromise = new Promise((resolve)=>{
    ...
    document.addEventListener("click", ()=>{
        ...
        if (isLeftClicked && isRightClicked) resolve(`Third promise was resolved`);
    }, {
        once: true
    });
...
firstPromise.then((message)=>showMessage(message), (errorMessage)=>showMessage(errorMessage, true));
